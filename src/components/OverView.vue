<template>
    <section id="overview">
        <div class="container">
            <div class="row header-text text-center" id="features" style="padding-top: 150px">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="over-item txt-right unique-style3">
                                ...
                                <p>There is no pre-sale. <a href="https://docs.moonrat.finance/tokenomics/introduction" target="_blank">96% of supply will be given to community </a>. Dev burned all team tokens and plans to introduce
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="over-item txt-left unique-style4">
                                <img :src="require('@/assets/images/icon-06.png')" alt="banner-img" class="img-fluid image-icon">
                                <div class="break"></div>
